...
class RolesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view(view: "admin::{$module_name}.create", data: compact('module_title', 'module_name', 'module_icon', 'module_action', 'roles', 'permissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(view: "admin::{$module_name}.edit", data: compact('module_title', 'module_name', "{$module_name_singular}", 'module_name_singular', 'module_icon', 'module_action', 'permissions', 'role_users_count', 'is_protected_role'));
    }
